...
<head>
    ...
    <style>
        :root { --ink:#102a44; --muted:#5d6573; --cream:#ebeff2; --paper:#f7f8fb; --accent:#1e5bb0; --accent-dark:#163f7a; --line:#d4dae2; --shadow:0 18px 42px rgba(35,45,55,.08); }
        * { box-sizing:border-box; } body { margin:0; min-height:100vh; font-family:Inter,Segoe UI,system-ui,sans-serif; color:var(--ink); background:radial-gradient(circle at top left,rgba(216,224,233,.25) 0,transparent 31rem),var(--cream); line-height:1.55; }
        a { color:var(--accent); text-decoration:none; font-weight:600; } a:hover { color:var(--accent-dark); }
        .navbar { background:rgba(239,243,247,.96); backdrop-filter:blur(12px); border-bottom:1px solid var(--line); position:sticky; top:0; z-index:10; }
        ...
        .card { overflow:hidden; border:1px solid rgba(92,100,112,.12); border-radius:22px; background:var(--paper); box-shadow:var(--shadow); } .card-body { padding:1.55rem; } .card-footer,.card-header { padding:1rem 1.55rem; background:#e7eaef; border:0; } .card-header { font-weight:750; } .h-100 { height:100%; } .h5 { font-size:1.22rem; } .h4 { font-size:1.45rem; } .h3 { font-size:1.8rem; }
