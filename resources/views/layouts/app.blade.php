...
<head>
    ...
    <style>
        ...
        * { box-sizing:border-box; } body { margin:0; min-height:100vh; font-family:Inter,Segoe UI,system-ui,sans-serif; color:var(--ink); background:radial-gradient(circle at top left,#dbe9ff 0,transparent 31rem),var(--cream); line-height:1.55; }
        ...
        .form-label { display:block; margin:.25rem 0 .45rem; font-weight:750; } .form-control,.form-select { width:100%; padding:.78rem .9rem; border:1px solid #dfc8b6; border-radius:12px; background:#fff; color:var(--ink); font:inherit; outline:none; } .form-control:focus,.form-select:focus { border-color:var(--accent); box-shadow:0 0 0 4px rgba(30,91,176,.13); } textarea.form-control { resize:vertical; min-height:90px; } .form-check { margin:.55rem 0; } .form-check-input { accent-color:var(--accent); margin-right:.35rem; } .btn-close { border:0; background:transparent; font-size:1rem; cursor:pointer; } .btn-close:after { content:'×'; }
