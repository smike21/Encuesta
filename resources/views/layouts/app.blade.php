...
<head>
    ...
    <style>
        :root { --ink:#16283d; --muted:#5c6b7a; --cream:#e4e8ed; --paper:#f7f9fb; --paper-dark:#dde3ea; --accent:#2563eb; --accent-dark:#1a3f8f; --line:#c7cfd8; --line-dark:#9aa7b5; --shadow:0 18px 42px rgba(22,40,61,.10); }
        * { box-sizing:border-box; } body { margin:0; min-height:100vh; font-family:Inter,Segoe UI,system-ui,sans-serif; color:var(--ink); background:radial-gradient(circle at top left,rgba(22,40,61,.08) 0,transparent 31rem),var(--cream); line-height:1.55; }
        a { color:var(--accent); text-decoration:none; font-weight:600; } a:hover { color:var(--accent-dark); }
        .navbar { background:rgba(217,224,233,.98); backdrop-filter:blur(12px); border-bottom:1px solid var(--line); position:sticky; top:0; z-index:10; }
        ...
        .card { overflow:hidden; border:1px solid rgba(85,90,99,.16); border-radius:22px; background:var(--paper); box-shadow:var(--shadow); } .card-body { padding:1.55rem; } .card-footer,.card-header { padding:1rem 1.55rem; background:var(--paper-dark); border:0; } .card-header { font-weight:750; } .h-100 { height:100%; } .h5 { font-size:1.22rem; } .h4 { font-size:1.45rem; } .h3 { font-size:1.8rem; }
        .btn { display:inline-flex; align-items:center; justify-content:center; border:1px solid transparent; border-radius:999px; padding:.72rem 1.15rem; background:var(--accent); color:#fff!important; font:inherit; font-weight:750; cursor:pointer; box-shadow:0 9px 18px rgba(22,40,61,.12); transition:transform .18s,background .18s; } .btn:hover { background:var(--accent-dark); transform:translateY(-2px); } .btn-outline-primary { color:var(--accent)!important; background:var(--paper); border-color:var(--line); box-shadow:none; } .btn-outline-warning { color:#4a5f83!important; background:var(--paper); border-color:var(--line); box-shadow:none; } .btn-outline-danger { color:#8b1f3d!important; background:var(--paper); border-color:var(--line); box-shadow:none; } .btn-sm { padding:.48rem .8rem; font-size:.84rem; } .w-100 { width:100%; }
        ...
        .form-label { display:block; margin:.25rem 0 .45rem; font-weight:750; } .form-control,.form-select { width:100%; padding:.78rem .9rem; border:1px solid var(--line-dark); border-radius:12px; background:var(--paper-dark); color:var(--ink); font:inherit; outline:none; } .form-control:focus,.form-select:focus { border-color:var(--accent); box-shadow:0 0 0 4px rgba(37,99,235,.13); } textarea.form-control { resize:vertical; min-height:90px; } .form-check { margin:.55rem 0; } .form-check-input { accent-color:var(--accent); margin-right:.35rem; } .btn-close { border:0; background:transparent; font-size:1rem; cursor:pointer; } .btn-close:after { content:'×'; }
